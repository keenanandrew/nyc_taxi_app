...
def main(params):
    ...
    if url.endswith(".csv.gz"):
        csv_name = f"{colour}_output.csv.gz"
    else:
        csv_name = f"{colour}_output.csv"
    ...
    while True:
        try:
            ...
            df.to_sql(name=colour, con=engine, if_exists="append")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--colour", help="the colour of taxi desired")
